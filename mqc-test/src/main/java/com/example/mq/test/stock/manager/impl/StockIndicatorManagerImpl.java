...
import com.example.mq.test.stock.utils.StockCalculateUtils;
...
import com.example.mq.test.stock.manager.StockIndicatorManager;
...
public class StockIndicatorManagerImpl implements StockIndicatorManager {
    ...
    private DongChaiNorthHoldShareDTO getBeforeNorthHoldShareDTO(DongChaiNorthHoldShareDTO holdShareDTO
        ...
        DongChaiNorthHoldShareDTO beforeHoldShareDTO = historyHoldShareDTOList.stream()
                ...
                .filter(hisHoldShareDTO -> {
                    LocalDateTime hisDataTime = DateTimeUtils.parseLocalDateTime(hisHoldShareDTO.getTradeDate(), DateTimeUtils.DATE_TIME_FORMAT);
    ...
    private void queryIndustryHoldShareRatioChange(DongChaiIndustryHoldShareDTO holdShareDTO){
        ...
        String queryDate7 = DateTimeUtils.formatLocalDateTime(queryDateTime7, DateTimeUtils.DATE_TIME_FORMAT);
        ...
        String queryDate30 = DateTimeUtils.formatLocalDateTime(queryDateTime30, DateTimeUtils.DATE_TIME_FORMAT);
        ...
        String queryDate90 = DateTimeUtils.formatLocalDateTime(queryDateTime90, DateTimeUtils.DATE_TIME_FORMAT);
        ...
        String queryDate180 = DateTimeUtils.formatLocalDateTime(queryDateTime180, DateTimeUtils.DATE_TIME_FORMAT);
        ...
        String queryDate360 = DateTimeUtils.formatLocalDateTime(queryDateTime360, DateTimeUtils.DATE_TIME_FORMAT);
