...
public class IndicatorElementManagerImpl implements IndicatorElementManager {
    ...
    private void assembleHolderIncreaseElement(AnalyseIndicatorElement indicatorElement, String code, String kLineDate) {
        ...
        LocalDateTime startDateTime = DateTimeUtils.parseLocalDate(kLineDate, DateTimeUtils.DATE_FORMAT).plusDays(-180).atStartOfDay();
        LocalDateTime endDateTime = DateTimeUtils.parseLocalDate(kLineDate, DateTimeUtils.DATE_FORMAT).plusDays(91).atStartOfDay();
    ...
    private void assembleFreeShareElement(AnalyseIndicatorElement indicatorElement, String code, String kLineDate) {
        ...
        LocalDateTime startDateTime = DateTimeUtils.parseLocalDate(kLineDate, DateTimeUtils.DATE_FORMAT).plusDays(-90).atStartOfDay();
        LocalDateTime endDateTime = DateTimeUtils.parseLocalDate(kLineDate, DateTimeUtils.DATE_FORMAT).plusDays(180).atStartOfDay();
    ...
    private void assemblePledgeDataElement(AnalyseIndicatorElement indicatorElement, String code, String kLineDate) {
        ...
        LocalDateTime startDateTime = DateTimeUtils.parseLocalDate(kLineDate, DateTimeUtils.DATE_FORMAT).plusDays(-365).atStartOfDay();
