...
public class GeoHashUtils {
	 ...
	 * @return 二进制编码
	 */
	public static long getBinaryAsLong(double lon, double lat, int precision) {
	...
	public static void main(String[] args) {
		System.out.println(GeoHashUtils.getBinaryAsLong(110.0001d, 20.0001d, 20));
		System.out.println(GeoHashUtils.getBinaryAsLong(119.0002d, 20.0002d, 20));
	}
