package com.example.mq.app.dubbo.model;
...
public class DubboReferenceCache {
	...
	private long updateCache(String requestName) throws Exception{
		...
		// feature config
		DubboRegisterConfig dubboRegisterConfig = dubboConfigService.getRegisterConfig(requestName);
		DubboRequestConfig dubboRequestConfig = dubboConfigService.getRequestConfig(requestName);
