package com.example.mq.adapter.model.impl;
...
public class AsyncCustomerServiceImpl {
	private static final Logger LOG = LoggerFactory.getLogger(AsyncCustomerServiceImpl.class);
